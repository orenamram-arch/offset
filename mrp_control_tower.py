...
# מיפוי PN -> אינדקס שורה ב-df_raw (לפי עמודת PN_ID הגולמית, עמודה 1) - נחוץ
# ל-get_cumulative_incoming_supply, שנקראת המון פעמים בחישובי CTB/קיבולת
# מקסימלית ובעבר סיננה את כל df_raw (כולל המרת מחרוזות) בכל קריאה בודדת.
_df_raw_pnid_series = df_raw.iloc[:, 1].astype(str).str.strip()
DF_RAW_PN_ROW_INDEX = {}
