...
""")
    ...
    with tab_tree:
        ...
        st.markdown("#### 🎯 דריל-דאון: השרשרת שקובעת את התאריך, מהשורש (רמה 0) ועד לרכיב שבאמת אשם")
                ...
                for _i, _cnode in enumerate(_chain):
                    ...
                    if _is_last and _last_is_stock:
                        ...
                        st.markdown(
                            ...
                            f"<span style='font-weight:400; font-size:12px;'>{_kind_label} | זמין במלאי עכשיו - לא חוסם בפועל</span>"
                            f"</div>",
                            unsafe_allow_html=True
                        )
                        continue
                    ...
                    st.markdown(
                        ...
                        f"<span style='font-weight:400; font-size:12px;'>{_kind_label} | מוכנות: {_cdate}{_tag}</span>"
                        f"</div>",
                        unsafe_allow_html=True
                    )
                    if not _is_last:
        ...
        def _render_cp_node(node_id, root_pn, depth):
            ...
            label = f"{icon} {node['pn']} — {node['desc']}  |  מוכנות: {date_str}{slack_txt}"
