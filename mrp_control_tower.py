...
""")
    ...
    if not _bom_positions:
        ...
        st.plotly_chart(fig_tree, use_container_width=False)
        st.caption(f"סה\"כ {len(_bom_positions)} הרכבות, {max_y + 1} רמות עומק. (התרשים ברוחב קבוע - גוללים אופקית אם העץ רחב מהמסך)")
