...
_project_popover = st.popover("📁 בחר / החלף פרויקט", use_container_width=True) if hasattr(st, "popover") else st.expander("📁 בחר / החלף פרויקט", expanded=True)
...
main_filters_popover = st.popover("🔍 פתח את כל המסננים", use_container_width=True)
