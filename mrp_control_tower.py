...
""")
    ...
    st.markdown(
        ...
        "לאחר שממלאים את שני השדות, יופיע כפתור **\"💾 שמור פרויקט זה לקבע (יופיע ברשימה בפעם הבאה)\"**, "
        "ולחיצה עליו תשמור את הפרויקט כך שיופיע אוטומטית בתפריט הצדדי בכל כניסה עתידית."
    )
