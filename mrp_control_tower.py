...
/* ==========================================================
   שיפור: הסתרת כל האייקונים/קישורים שמובילים החוצה מהאפליקציה
   (GitHub, Streamlit, כפתור Deploy, סרגל הכלים העליון) - כדי שלא
   יהיה אפשר להגיע דרך האפליקציה לריפו ב-GitHub או לניהול ב-Streamlit
   Cloud. #MainMenu/footer כבר היו מוסתרים למעלה; זה מרחיב את זה
   לסרגל הכלים העליון (header) ולכל קישור חיצוני ל-github.com/streamlit.io
   בכל מקום בעמוד, כתפיסת-רשת כללית ולא רק לאייקונים ידועים מראש.
   ========================================================== */
