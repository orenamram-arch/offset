...
if st.sidebar.button("🔄 רענן נתונים (נקה קאש)", help="לוחצים כאן אם עדכנת קובץ ב-GitHub והאפליקציה עדיין מציגה נתונים ישנים - זה מנקה את כל מטמון הנתונים, פורץ גם קאש CDN של GitHub עצמו, ומכריח טעינה מחדש אמיתית, בלי לצאת ל-Streamlit Cloud."):
    load_data.clear()
    fetch_all_inventory_records.clear()
    fetch_wip_records.clear()
    fetch_saved_projects.clear()
...
if not month_options:
    st.error(
        ...
        "נסה את הכפתור '🔄 רענן נתונים (נקה קאש)' למעלה בסיידבר, "
